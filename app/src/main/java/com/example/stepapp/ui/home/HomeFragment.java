            ...
            public void onButtonChecked(MaterialButtonToggleGroup group, int checkedId, boolean isChecked) {
                if (group.getCheckedButtonId() == R.id.toggleStart) {
                    ...
                    if (mSensorSD != null) {
                        ...
                        Toast.makeText(getContext(), "step_not_available", Toast.LENGTH_SHORT).show();
                    }
...
class StepCounterListener implements SensorEventListener {
    ...
    public void onSensorChanged(SensorEvent event) {
        ...
        switch (event.sensor.getType()) {
            ...
            case Sensor.TYPE_STEP_DETECTOR:
                ...
                float step_value = event.values[0];
                countSteps(step_value);
                Log.d("ACC", "Step_detector: " + String.valueOf(mAndroidStepCount));
        }
    }
    ...
    private void countSteps(float step) {
        if (step == 1.0) mAndroidStepCount++;
        stepsProgressBar.setProgress(mAndroidStepCount);
